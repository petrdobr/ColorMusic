...
// проверь определения REMOTE_TYPE, NUM_LEDS, BRIGHTNESS, BTN_PIN, IR_PIN, MONO, POTENT, SETTINGS_LOG
...
#define BTN_PIN 3          // кнопка переключения режимов (PIN --- КНОПКА --- GND)    // НЕ ИСПОЛЬЗУЕТСЯ! 3 пин занят землей.
...
#define LED_RES 9              // пин крепления резистора светодиодной ленты
#endif

#define POT_GND A0              // пин земля для потенциометра

#define IR_PIN 2                // пин ИК приёмника
#define IR_GND 5                // пин - ИК приёмника
#define IR_VCC 4                // пин + ИК приёмника
